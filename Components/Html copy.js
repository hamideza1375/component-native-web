...
export const Button = React.forwardRef((props, ref) => <TouchableOpacity ref={ref} onPress={props.onPress} {...props} style={[{ justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderRadius: 5, backgroundColor:'#eee', borderColor:'silver', height:'100%', },props.style]} ><Text style={[{ textAlign: 'center', justifyContent: 'center', alignItems: 'center', borderRadius: 5,paddingVertical:9, paddingHorizontal:20, },props.textStyle]} >{props.children}</Text></TouchableOpacity>)
...
export const ScrollHorizontal = React.forwardRef((props, ref) => <ScrollView ref={ref} horizontal={true} {...props} style={[props.className, props.style]} >{props.children}</ScrollView>)
...
export const Tb = React.forwardRef((props, ref) => <View ref={ref} {...props} style={[{ flex: 1, backgroundColor: 'white', borderColor: '#666', borderWidth: .8, justifyContent: 'center', alignItems: 'center', borderRadius: 1.5 }, props.style]} ><Text style={[{fontFamily,fontWeight:'600',color:'#555', fontSize,paddingVertical:10, },props.textStyle]} > {props.children}</Text></View>)

export const Tbtn = React.forwardRef((props, ref) => <View ref={ref} {...props} style={[{ flex: 1, backgroundColor: 'white', borderColor: '#666', borderWidth: .8, justifyContent: 'center', alignItems: 'center', borderRadius: 1.5, }, props.style]} ><Button style={{width: '99.8%'}} textStyle={[{paddingVertical:10, fontFamily,fontWeight:'600',color:'#555', fontSize }, props.textStyle]} >{props.children}</Button></View>)
...
export const CheckBox = (props) => {
  return <Icon checked={props.show} onPress={()=>props.setShow(!props.show)} name={"check"} size={18} color="#fff" {...props} style={[{ width: 18, borderWidth: .9, }, { backgroundColor: props.show === false ? '#fff' : "#2c1" }, props.style]} />
}
